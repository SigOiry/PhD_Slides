...
::: {.absolute .fragment .fade-in fragment-index="7" top="30%" left="0%" }
Resilient to:
...
::: {.absolute .fragment .fade-in-then-out fragment-index="10" top="15.5%" left="35%" }

:::{.absolute top="-9%" left="10%" style="z-index: 99;"}
Aveiro, Portugal, 2021
:::


<video src="Video/Part2/gracilaria_aveiro.MP4" height="410" autoplay loop muted playsinline style=".circular-fade;"></video>
