...
::: {.gradient_box style="text-align: center; position: absolute; left: 50%; top: 22%; width: 1800px; transform: tran0slate(-50%, -50%)"}
...
::: {.absolute .fragment .fade-in fragment-index="9" top="20%" left="0%" }
...
- Ignored by local species, no grasing
:::
...
::: {.incremental}
- This PhD advanced **multi-scale RS techniques** for characterising intertidal vegetation.
