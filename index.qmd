...
## Remote Sensing
::: {.absolute top="6%" .fragment .fade-out fragment-index="2"}
...
```{=html}
<video class="fragment fade-out" data-fragment-index="1" autoplay muted loop playsinline height="1450">
  <source src="Video/Intro/Oyster_reef_intertidal1.mp4" type="video/mp4">
...
```{=html}
<video class="fragment fade-in" data-fragment-index="1" autoplay muted loop playsinline height="1450">
  <source src="Video/Intro/Drone_Flight.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
::: {.absolute top="6%" .fragment .fade-in fragment-index="2"} 
*Remote Sensing platforms from the sky to the sea *
:::
...
Applyed to Earth Obsevation: 
:::

::: {.absolute top="65%" left="0%" .fragment .fade-in fragment-index="3"}
![](Images/Intro/Sentinel2_1.png){height="400" .circular-fade}
:::

::: {.absolute top="65%" left="17%" .fragment .fade-in fragment-index="3"}
![](Images/Intro/Airbornn.png){height="400" .circular-fade}
:::

::: {.absolute top="65%" left="34%" .fragment .fade-in fragment-index="3"}
![](Images/Intro/Drone_MPB1.png){height="400" .circular-fade}
:::

::: {.absolute top="65%" left="51%" .fragment .fade-in fragment-index="3"}
...
::: {.absolute top="45%" left="0%" .fragment .fade-in fragment-index="4"}
![](Images/Intro/Sentinel2.png){height="400" .circular-fade}
:::

::: {.absolute top="45%" left="22%" .fragment .fade-in fragment-index="4"}
![](Images/Intro/Drone_MPB.jpg){height="400" .circular-fade}
:::

::: {.absolute top="45%" left="44%" .fragment .fade-in fragment-index="4" style="z-index: 9999;"}
![](Images/Intro/Quadrats.jpg){height="400" .circular-fade}
:::

::: {.absolute left="2%" top="77%" style="font-size: 40px;" .fragment .fade-in fragment-index="4"} 
**Sentinel-2** 
:::

::: {.absolute left="24%" top="77%" style="font-size: 40px;" .fragment .fade-in fragment-index="4"} 
**Drone**
:::

::: {.absolute left="46%" top="77%" style="font-size: 40px;" .fragment .fade-in fragment-index="4"} 
***In situ*** 
:::

::: {.absolute left="4%" top="82%" style="font-size: 35px;" .fragment .fade-in fragment-index="4"}
...
::: {.absolute left="26%" top="82%" style="font-size: 35px;" .fragment .fade-in fragment-index="4"}
...
::: {.absolute left="48%" top="82%" style="font-size: 35px;" .fragment .fade-in fragment-index="4"}
...
::: {.absolute top="6%"}
*A multi-scale approach to monitor and understand intertidal vegetation*
:::

::: {.absolute top="25%" left="5%" style="font-size: 55px;" .fragment .fade-in fragment-index="1"}
- Monitor and characterize intertidal vegetation across European coastlines  
:::

::: {.absolute top="40%" left="10%" style="font-size: 48px;" .fragment .fade-in fragment-index="2"}
- Assess impacts of **natural pressures** (e.g. heatwaves)  
- Assess impacts of **anthropogenic pressures** (e.g. aquaculture, dredging)  
:::

::: {.absolute top="60%" left="10%" style="font-size: 48px;" .fragment .fade-in fragment-index="3"}
- Develop **remote sensing methodologies** across multiple spatial scales  
- Validate remote sensing products with **in situ** observations  
:::

::: {.absolute top="80%" left="10%" style="font-size: 48px;" .fragment .fade-in fragment-index="4"}
- Provide tools for **ecosystem monitoring** and **coastal management**  
:::
