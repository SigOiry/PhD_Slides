...
::: {.absolute left="1%" top="12%" style="font-size: 40px; color: black;"}
Saltmarshes
:::

::: {.absolute left="29%" top="12%" style="font-size: 40px; color: white;"}
Mangroves
:::

::: {.absolute left="60%" top="12%" style="font-size: 40px; color: black;"}
Polychaete reefs
:::

::: {.absolute left="1%" top="50%" style="font-size: 40px; color: black;"}
Rocky reefs
:::

::: {.absolute left="40%" top="50%" style="font-size: 40px; color: white;"}
Mudflats
:::

::: {.absolute left="68.2%" top="50%" style="font-size: 40px; color: black;"}
Oyster reefs
:::
...
:::
::: {.absolute top="-4%" right="7%" style="font-size: 30px;"}
...
:::
::: {.absolute top="-4%" right="7%" .fragment .fade-out fragment-index="2" style="font-size: 30px;"}
*Vigo, Spain*
:::
...
::: {.absolute left="2%" top="15%" style="font-size: 50px;"}
...
::: {.absolute .fragment .fade-in fragment-index="1" left="2%" top="45%" style="font-size: 50px;"}
Remote Sensing: 
:::

::: {.absolute .fragment .fade-in fragment-index="1" left="5%" top="50%"}
  - Cost effective
