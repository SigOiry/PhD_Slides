...
![](Images/Part1/Figure_Hyperspectral_Faded.gif){height="630"}
:::

:::{.absolute top="5%" left="50%" style="font-size: 60px;"}
Challenge to map green macrophytes
:::

:::{.absolute top="10%" left="55%" style="font-size: 60px;"}
- Similar pigment composition
- Spectral resolution
- Oftenly co-occur in intertidal areas
:::

:::{.absolute top="35%" left="50%" .fragment .fade-in fragment-index="1" style="font-size: 60px;"}
- Difference in carotenoid to chlorophyll-a ratios ([Repolho et al., 2017](http://doi.org/10.1038/srep41443))
:::

:::{.absolute top="50%" left="50%" .fragment .fade-in fragment-index="2" style="font-size: 60px;"}
- ~530 nm & ~650 nm are important wavelength
:::

:::{.absolute top="62%" left="50%" .fragment .fade-in fragment-index="3" style="font-size: 60px;"}
- Ultra high spatial resolution (from 80 to 8mm per pixel)
:::

:::{.absolute top="74%" left="50%" .fragment .fade-in fragment-index="4" style="font-size: 60px;"}
...
:::{.absolute top="86%" left="50%" .fragment .fade-in fragment-index="4" style="font-size: 60px;"}
