...
::: {.absolute bottom="-8%" .fragment .fade-in fragment-index="2" right="-7.6%"}
...
::: {.absolute top="70%" left="5%" .fragment .fade-in-then-out fragment-index="5" style="font-size: 50px;"}
...
::: {.fragment .fade-out fragment-index="8"}
::: {.absolute top="6.5%" .fragment .fade-in fragment-index="1"}
*Historical records in the Belon estuary*
:::

::: {.absolute .fragment .fade-in fragment-index="1" bottom="-8%" right="-7.6%"}
![](Images/Part2/Map_Belon.png){height="1400"}
:::
:::

::: {.absolute top="15%" left="0%" .fragment .fade-in-then-out fragment-index="1"}
...
:::{.absolute .fragment .fade-out fragment-index="1" top="15%" left="45%" style="font-size: 50px;"}
...
:::{ .fragment .fade-out fragment-index="4"}
:::{.absolute .fragment .fade-in fragment-index="1" top="15%" left="45%" style="font-size: 50px;"}
**First map of the spatial distribution of *G. vermiculophylla***
:::
...
::: {.absolute .fragment .fade-out fragment-index="1" top="15%" left="5%"}
![](Images/Part2/Saja_Belon_DISCOV_void.png){height="500"}
:::

::: {.absolute .fragment .fade-out fragment-index="1" bottom="0%" left="5%"}
...
::: {.absolute .fragment .fade-out fragment-index="1" bottom="0%" right="5%"}
...
::: {.fragment .fade-out fragment-index="1" style="position: absolute; top: 77%; left: 49.2%; transform: translate(-50%, -50%);"}
...
# General conclusions and future perspectives {data-name="Discussion"}
