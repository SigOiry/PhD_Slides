...
![](Images/Part2/Oyster_edulis.png){height="800"}
:::

::: {.absolute .fragment .fade-out fragment-index="2" top="15%" right="0%" }
::: {.absolute bottom="-5%" right="10%"}
*Flat Oyster*
:::

![](Images/Part2/flat_oyster.jpg){height="700"}
:::


::: {.absolute .fragment .fade-in-then-out fragment-index="1" top="15%" left="0%" }
![](Images/Part2/Oyster_edulis2.png){height="800"}
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="2" top="15%" left="0%" }
![](Images/Part2/Oyster_angulata.gif){height="800"}
:::
...
![](Images/Part2/Portuguese_oyster.jpg){height="700"}
:::
:::
...
![](Images/Part2/gigas.jpg){height="700"}
:::
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="3" top="15%" left="0%" }
![](Images/Part2/Oyster_angulata2.png){height="800"}
:::
::: {.absolute .fragment .fade-in-then-out fragment-index="4" top="15%" left="0%" }
![](Images/Part2/Oyster_gigas.gif){height="800"}
:::
...
::: {.absolute .fragment .fade-in fragment-index="9" top="15%" left="0%" }
:::{.absolute .fragment .fade-out fragment-index="10" top="-7%" left="0%" style="font-size: 30px;"}
First observation in Europe in the Belon, Brittany, in 1996
::: 
:::{.absolute .fragment .fade-in fragment-index="10" top="-8%" left="10%"}
...
:::
:::
::: {.absolute .fragment .fade-in-then-out fragment-index="10" top="16%" left="35%" }
...
::: {.absolute .fragment .fade-in-then-out fragment-index="10" top="15%" left="65%" }
...
::: {.absolute .fragment .fade-in-then-out fragment-index="10" top="47%" right="29%" }
...
::: {.absolute .fragment .fade-in-then-out fragment-index="10" top="47%" right="0%" }
:::{.absolute bottom="-8%" right="10%"}
Scorff, France, 2024
:::
...
::: {.absolute .fragment .fade-in-then-out fragment-index="10" top="47%" right="58%" }
:::{.absolute bottom="-8%" right="10%"}
...
:::
![](Images/Part2/map_invasion_world.png){height="1000"}
:::


::: {.absolute .fragment .fade-out fragment-index="5" bottom="0%" right="0%" }
...
**G**eneralized **L**inear **M**ixed **M**odel 
:::
...
::: {.fragment .fade-out fragment-index="18"}
::: {.absolute .fragment .fade-in fragment-index="16" top="10%" left="0%"}
...
::: {.absolute .fragment .fade-in-then-out fragment-index="16" bottom="-5%" right="20%"}
...
::: {.absolute .fragment .fade-in-then-out fragment-index="17" bottom="-5%" right="20%"}
::: {.absolute bottom="15%" left="-30%"}
*Slope Categorized*
:::
...
::: {.fragment .fade-out fragment-index=2}
::: {.absolute top="5%" left="40%"}

:::{.absolute top="-7%" right="5%"}
*Aveiro Lagoon, Portugal, June 2022*
:::

![](Images/Part3/White_seagrass-Gafanha.png){height="500"}
:::
:::

::: {.absolute .fragment .fade-in bottom="0%" left="45%" fragment-index="1"}
![](Images/Part3/Darkseagrass_quiberon.jpg){height="600"}
:::



::: {.absolute .fragment .fade-in bottom="0%" left="60%" fragment-index="1"}
![](Images/Part3/Green_seagrass_Quiberon.jpg){height="600"}
:::

:::{.absolute .fragment .fade-in fragment-index="1" bottom="5%" right="2%"}
*Quiberon, France, September 2021*
:::

::: {.absolute .fragment .fade-in top="53%" right="8%" fragment-index="1"}
![](Images/Part3/Logo_Biolittoral.png){height="80"}
:::
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="2" top="0%" left="50%"}

![](Images/Part3/plot_temp.png){height="650"}
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="3" top="0%" left="50%"}

![](Images/Part3/plot_temp2.png){height="650"}
:::
...
::: {.absolute .fragment .fade-in top="15%" left="0%" fragment-index="4"}
![](Images/Part3/Paper_intro1.png){height="200"}
:::

::: {.absolute .fragment .fade-in top="35%" left="0%" fragment-index="4"}
![](Images/Part3/Paper_intro2.png){height="200"}
:::

::: {.absolute .fragment .fade-in top="55%" left="0%" fragment-index="4"}
![](Images/Part3/Paper_intro31.png){height="200"}
:::

::: {.absolute .fragment .fade-in top="75%" left="0%" fragment-index="4"}
![](Images/Part3/Paper_intro4.png){height="200"}
:::


::: {.absolute .fragment .fade-in fragment-index="4" top="10%" left="30%" style="font-size: 50px;"}
On subtidal *Zostera marina* and *Cymodocea nodosa*: 
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="5" width="1200" top="15%" left="35%" style="font-size: 50px;"}
...
::: {.absolute .fragment .fade-in-then-out fragment-index="6" width="1200" top="15%" left="35%" style="font-size: 50px;"}
- Highly vulnerable to elevated sea temperatures in winter and spring, leading to early flowering, high mortality, and reduced biomass.
- Photosynthetic activity rises during HWs but diminishes during recovery, impairing performance and reducing leaf biomass.
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="7" width="1200" top="15%" left="35%" style="font-size: 50px;"}
- Highly vulnerable to elevated sea temperatures in winter and spring, leading to early flowering, high mortality, and reduced biomass.
- Photosynthetic activity rises during HWs but diminishes during recovery, impairing performance and reducing leaf biomass.
- Responses vary greatly between species...
:::

::: {.absolute .fragment .fade-in fragment-index="8" width="1200" top="15%" left="35%" style="font-size: 50px;"}
- Highly vulnerable to elevated sea temperatures in winter and spring, leading to early flowering, high mortality, and reduced biomass.
- Photosynthetic activity rises during HWs but diminishes during recovery, impairing performance and reducing leaf biomass.
- Responses vary greatly between species...
...
::: {.absolute .fragment .fade-in fragment-index="9" bottom="25%" left="30%" style="font-size: 75px;"}
What about *Zostera noltei* ?  
:::

::: {.absolute .fragment .fade-in fragment-index="9" bottom="15%" left="30%" style="font-size: 75px;"}
Impact on the reflectance ? 
:::

::: {.absolute .fragment .fade-in fragment-index="9" bottom="5%" left="30%" style="font-size: 75px;"}
...
::: {.absolute .fragment .fade-in fragment-index="10" top="6.5%"}
*Extreme Temperature Events = Heatwaves*
:::

::: {.absolute .fragment .fade-in fragment-index="10" top="10%" left="10%"}
![](Images/Part3/Paper_intro5.png){height="300"}
:::

::: {.absolute .fragment .fade-in fragment-index="10" top="10%" right="0%"}
...
::: {.absolute .fragment .fade-in-then-out fragment-index="12" top="36%" left="5%" style="font-size: 50px; text-align: center;"}
...
::: {.absolute .fragment .fade-in-then-out fragment-index="13" top="36%" left="5%" style="font-size: 50px; text-align: center;"}
...
::: {.absolute .fragment .fade-in-then-out fragment-index="14" top="36%" left="5%" style="font-size: 50px; text-align: center;"}
...
::: {.fragment .fade-out fragment-index="16"}
::: {.absolute .fragment .fade-in fragment-index="15" top="36%" left="5%" style="font-size: 50px; text-align: center;"}
...
::: {.absolute .fragment .fade-in-then-out bottom="0%" left="5%" fragment-index="13"}
![](Images/Part3/plot_temp_mean.png){height="600"}
:::

::: {.absolute .fragment .fade-in-then-out bottom="0%" left="5%" fragment-index="14"}
![](Images/Part3/plot_Tmax.png){height="600"}
:::

::: {.absolute .fragment .fade-in-then-out bottom="0%" left="5%" fragment-index="15"}
![](Images/Part3/plot_Tmax_flame.png){height="600"}
:::

::: {.absolute .fragment .fade-in fragment-index="16" top="6.5%"}
*Hypothesis & Objectives*
:::


::: {.absolute top="15%" .fragment .fade-in fragment-index="16" style="font-size: 75px;"}
Heatwaves alter the spectral reflectance of *Zostera noltei* seagrass. This change can be detected using remote sensing. 
:::

::: {.absolute .incremental .fragment .fade-in fragment-index="16" top="33%" style="font-size: 75px;"}
...
::: {.fragment .fade-in-then-out fragment-index="7" .absolute top="10%" left="0%"}
![](Images/Part3/plot_Temp_Quiberon1.png){width="1400"}
:::

::: {.fragment .fade-out fragment-index="11"}

::: {.absolute top="6.5%" left="0%" .fragment .fade-in fragment-index="7"}
*Satellite Mapping of the impact of Heatwaves on seagrasses*
:::

::: {.fragment .fade-in fragment-index="7" style="text-align: center; position: absolute; left: 80%; top: 20%; width: 800px; transform: translate(-50%, -50%)"}
...
::: {.absolute .fragment .fade-in fragment-index="7" left="0%" top="45%"}
```{=html}
<iframe width="1400" height="800" src="maps/map_Quiberon_presentation.html" title="Webpage example"></iframe>
```
:::

::: {.fragment .fade-in-then-out fragment-index="8" .absolute top="10%" left="0%"}
![](Images/Part3/plot_Temp_Quiberon2.png){width="1400"}
:::

::: {.fragment .fade-in-then-out fragment-index="9" .absolute top="10%" left="0%"}
![](Images/Part3/plot_Temp_Quiberon3.png){width="1400"}
:::

::: {.fragment .fade-in-then-out fragment-index="10" .absolute top="10%" left="0%"}
![](Images/Part3/plot_Temp_Quiberon4.png){width="1400"}
:::

::: {.fragment .fade-in fragment-index="8" .absolute top="35%" left="65%"}
![](Images/Part3/Sentinel2.png){width="500"}
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="8" top="70%" left="60%" style="font-size: 50px;"}
3 Sentinel-2 images, level L2A, Low Tide:

- **Before**: 1st of September 2021
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="9" top="70%" left="60%" style="font-size: 50px;"}
3 Sentinel-2 images, level L2A, Low Tide:
...
::: {.absolute .fragment .fade-in fragment-index="10" top="70%" left="60%" style="font-size: 50px;"}
3 Sentinel-2 images, level L2A, Low Tide:
...
::: {.absolute top="6.5%" left="0%" .fragment .fade-in fragment-index="15" style="font-size: 40px;"}
*Both Experimental and Satellite Mapping*
:::
  
::: {.absolute .fragment .fade-in-then-out fragment-index="15" top="15%" left="0%" style="text-align: right; font-size: 70px;"}
- Well established radiometric Indices:
:::

:::{.absolute top="30%" left="10%" .fragment .fade-in-then-out fragment-index="15" style="font-size: 50px;"}
$$
f''(\lambda_i) \approx \frac{f(\lambda_{i+1}) - 2f(\lambda_i) + f(\lambda_{i-1})}{(\Delta \lambda)^2}
$$ 
:::
  
::: {.absolute .fragment .fade-in-then-out fragment-index="15" top="50%" left="10%" style="text-align: right; font-size: 50px;"}

$$NDVI = \frac{R(NIR)-R(Red)}{R(NIR)+R(Red)}$$
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="15" top="70%" left="10%" style="text-align: right; font-size: 50px;"}
...
::: {.absolute .fragment .fade-in fragment-index="7" top="6.5%" left="0%"}
*in situ Satellite Mapping*
:::


::: {.fragment .fade-in-then-out fragment-index="7" .absolute bottom="0%"}
...
::: {.fragment .fade-in-then-out fragment-index="7" .absolute top="10%" right="0%"}
![](Images/Part3/plot_Temp_Quiberon3.png){width="1300"}
:::

::: {.fragment .fade-out fragment-index="12"}
::: {.fragment .fade-in fragment-index="8" .absolute top="10%" right="0%"}
![](Images/Part3/plot_Temp_Quiberon3_field.png){width="1300"}
:::
:::

::: {.fragment .fade-out fragment-index="12"}
::: {.fragment .fade-in fragment-index="8" .absolute bottom="0%"}
...
::: {.absolute .fragment .fade-in fragment-index="7" top="17%" left="0.5%" style="text-align: right; font-size: 50px;"}
[Before]{style="color:white;"}
:::

::: {.absolute .fragment .fade-in fragment-index="7" top="17%" left="39%" style="text-align: right; font-size: 50px;"}
[During]{style="color:white;"}
:::

::: {.fragment .fade-in-then-out fragment-index="10" .absolute top="40%" right="8%"}
![](Images/Part3/Spectra_before.png){width="1000"}
:::

::: {.fragment .fade-in-then-out fragment-index="11" .absolute top="40%" right="8%"}
![](Images/Part3/Spectra_after.png){width="1000"}
:::

::: {.fragment .fade-in fragment-index="12" .absolute top="10%" right="0%"}
![](Images/Part3/plot_Temp_Quiberon5.png){width="1300"}
:::

::: {.fragment .fade-in fragment-index="12" .absolute top="44%" right="-3%"}
...
::: {.fragment .fade-out fragment-index="13"}
::: {.fragment .fade-in fragment-index="12" .absolute top="15%" left="0%" width="2300px" height="1100px"}
...
::: {.fragment .fade-in fragment-index="12" .absolute top="35%" right="5%"}
![](Images/Part3/Scale__SHSI.png){height="500"}
:::

::: {.absolute .fragment .fade-in fragment-index="12" top="10%" left="0%" style="text-align: left; font-size: 50px;"}
Before
:::

::: {.absolute .fragment .fade-in fragment-index="12" top="10%" left="43%" style="text-align: center; font-size: 50px;"}
During
:::

::: {.absolute .fragment .fade-in fragment-index="12" top="10%" right="9%" style="text-align: right; font-size: 50px;"}
After
:::
:::

::: {.fragment .fade-in fragment-index="13" .absolute top="10%" left="0%"}
...
- but also by futur missions (Sentinel-2 Next Generation, LandSat Next)
:::
:::
...
ggsave("Images/Part3/HW_Freq_Inten.png", plot, height = 10, width = 9.57, dpi = 300)
```
...
- How does increasing heatwave pressure affect recovery capacity of Z. noltei?
...
- [Assessing Coastal Ecosystem Threats via RS](#ecosystem_threats)
- [Future Perspectives: Seagrass Restoration](#restoration)
...
## Assessing Coastal Ecosystem Threats via RS {#ecosystem_threats auto-animate="true"}
...
## Future Perspectives: Seagrass Restoration {#restoration auto-animate="true"}
...
## Overall Conclusion {#conclusion background-color="#005A9C" color="white"}
