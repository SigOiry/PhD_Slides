...
anim_save("Images/Part1/Figure_resampled_spectra.gif", animation = rendered)
  ...
  ggsave(filename = "Images/Part1/Figure_spectra3.pdf", 
       plot = plot_SRF_sp, 
       width = 10,
       height = 10, 
       units = "in")
...
::: {.absolute .fragment .fade-in-then-out fragment-index="2" top="5%" left="-5%"}
...
::: {.absolute .fragment .fade-in-then-out fragment-index="3" top="5%" left="-5%"}
